...
const EQUIVALENT_ROUTES: Record<string, boolean> = {
  ...
  "/faq": true,
  "/rfq": true,
  "/rfq/upload-drawing": true,
  "/rfq/request-quote": true,
  "/rfq/dfm-review": true,
  "/rfq/prototype-request": true,
  "/knowledge": true,
  "/knowledge/materials": true,
  "/knowledge/processes": true,
  "/knowledge/industries": true,
  "/knowledge/standards": true,
  "/knowledge/surface-finishes": true,
  "/knowledge/equipment": true,
  "/knowledge/cases": true,
  "/knowledge/evidence": true,
  "/sections": true,
  "/docs": true,
};
